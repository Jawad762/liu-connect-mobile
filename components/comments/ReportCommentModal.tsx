...
const ReportCommentModal = ({ visible, onRequestClose, comment }: { visible: boolean; onRequestClose: () => void; comment: Comment }) => {
    ...
    const handleReport = async () => {
        ...
        try {
            setLoading(true)
            const result = await commentService.reportComment(comment.id, selectedReason as ReportReason, details.trim() || undefined)
